...
public class DiscussPostService {
    ...
    public List<DiscussPost> findDisscussPosts(int usrId, int offset, int limit,int orderMode) {
        return discussPostMapper.selectDiscussPosts(usrId, offset, limit,orderMode);
    }
